...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-examTypeAssessments">
                <thead>
                <tr>
                    <th width="10">
...
@section('scripts')
    ...
    <script>
        $(function () {
            ...
            let table = $('.datatable-examTypeAssessments:not(.ajaxTable)').DataTable({ buttons: dtButtons })
