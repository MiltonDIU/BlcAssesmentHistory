...
@if($courses)
    @foreach($courses as $key => $course)
        <option value="{{ $course['courseCode'] ?? '' }}_{{ $course['courseTitle'] ?? '' }}_{{ $course['courseSectionId'] ?? '' }}_{{ $course['sectionName'] ?? '' }}_{{ $course['departmentId'] ?? '' }}_{{ $course['departmentName'] ?? '' }}_{{ $course['courseTypeId'] ?? '' }}_{{ $course['numberOfStudent'] ?? '' }}_{{ $course['totalCredit'] ?? '' }}">
        {{ $course['courseTitle'] ?? '' }}
