...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.assessmentList.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.assessment-lists.store") }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('program') ? 'is-invalid' : '' }}" name="program" id="program">
                        ...
                        @foreach(App\Models\AssessmentList::PROGRAM_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('program', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('blc_course_title') ? 'is-invalid' : '' }}" type="text" name="blc_course_title" id="blc_course_title" value="{{ old('blc_course_title', '') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('blc_course_code') ? 'is-invalid' : '' }}" type="text" name="blc_course_code" id="blc_course_code" value="{{ old('blc_course_code', '') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('blc_course_section') ? 'is-invalid' : '' }}" type="text" name="blc_course_section" id="blc_course_section" value="{{ old('blc_course_section', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('blc_assessment_question_link') ? 'is-invalid' : '' }}" type="text" name="blc_assessment_question_link" id="blc_assessment_question_link" value="{{ old('blc_assessment_question_link', '') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('blc_assessment_link') ? 'is-invalid' : '' }}" type="text" name="blc_assessment_link" id="blc_assessment_link" value="{{ old('blc_assessment_link', '') }}" required>
                ...
                <div class="form-group">
                    <label class="required" for="user_id">{{ trans('cruds.assessmentList.fields.user') }}</label>
                    ...
                    @endif
                    <span class="help-block">{{ trans('cruds.assessmentList.fields.user_helper') }}</span>
                </div>
                <div class="form-group">
